...

{
                                ...
                                <tr>
                                    ...
                                    <?php if($row['root'] == 1)
                                    {
                                        ...
                                        <td>
                                                ...
                                                <p class="text-danger fw-bold fs-6">Root admin can't be edited or deleted</p>
    ...
    elseif($open == 'Update'){
...

        {
            ...
            $stmt=$db->prepare('UPDATE users set username = ? , email = ? , name = ? where user_id = ? AND root = 0');
    ...
    elseif($open == 'Delete'){
        ...
        $stmt=$db->prepare('DELETE FROM users WHERE user_id = ? AND root = 0');
